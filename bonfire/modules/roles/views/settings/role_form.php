...
<div class="admin-box">
    <?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
        <fieldset>
            ...
            <div class="form-group row<?php echo form_error('role_name') ? ' error' : ''; ?>">
                <label class="col-4 col-form-label" for="role_name"><?php echo lang('role_name'); ?></label>
                <div class="col-8">
                    <input class="form-control" type="text" name="role_name" id="role_name" class="input-xlarge" value="<?php echo set_value('role_name', isset($role) ? $role->role_name : ''); ?>" />
                    <span class="help-inline"><?php echo form_error('role_name'); ?></span>
                </div>
            </div>
            <div class="description form-group row<?php echo form_error('description') ? ' error' : ''; ?>">
                <label class="col-4 col-form-label" for="description"><?php echo lang('bf_description'); ?></label>
                <div class="col-8">
            ...
            <div class="form-group row<?php echo form_error('login_destination') ? ' error' : ''; ?>">
                <label class="col-4 col-form-label" for="login_destination"><?php echo lang('role_login_destination'); ?></label>
                <div class="col-8">
            ...
            <div class="form-group row">
                <label class="col-4 col-form-label" for="default_context"><?php echo lang('role_default_context'); ?></label>
                <div class="col-8">
                    <select name="default_context" class="custom-select" id="default_context">
                        <?php
            ...
            <div class="form-group row<?php echo form_error('default') ? ' error' : ''; ?>">
                <label class="col-4 col-form-label" for="default"><?php echo lang('role_default_role'); ?></label>
                <div class="col-8">
            ...
            <div class="form-group row">
                <label class="col-4 col-form-label" id="can_delete_label"><?php echo lang('role_can_delete_role'); ?></label>
                <div class="col-8" aria-labelledby="can_delete_label" role="group">
