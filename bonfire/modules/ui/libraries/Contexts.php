...
class Contexts
{
    ...
    protected static $templateContextMenuAnchorClass = 'nav-link dropdown-toggle';
    ...
    protected static $outer_class = 'navbar-nav mr-auto';

    /** @var string The class to attach to li tags with children. */
    protected static $parent_class = 'nav-item dropdown';

    /** @var string The class to apply to li tags within ul tags inside. */
    protected static $submenu_class = 'dropdown-menu';
