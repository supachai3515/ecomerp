...
$config['auth_library_function'] = 'process_login';
...
// Overide Authen for Signup user
$config['auth_override_class_method']['api']['signup'] = 'none';
$config['auth_override_class_method']['api']['facebook'] = 'none';
