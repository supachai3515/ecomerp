...
<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
	...
	<div class="form-group <?php echo iif( form_error('password') , 'error') ;?>">
		...
		<div class="controls">
			<input class="col-6 form-control" type="password" name="password" id="password" value="" placeholder="Password...." />
	...
	<div class="form-group <?php echo iif( form_error('pass_confirm') , 'error') ;?>">
		...
		<div class="controls">
			<input class="col-6 form-control" type="password" name="pass_confirm" id="pass_confirm" value="" placeholder="<?php echo lang('bf_password_confirm'); ?>" />
		</div>
	</div>
