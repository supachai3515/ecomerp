...
class Auth
{
    ...
    public function restrict($permission = null, $uri = null)
    {
        ...
        Template::set_message(lang('us_no_permission'), 'danger');
    ...
    /**
     * Retrieve the company_id from the current session.
     *
     * @return integer The company's ID or false.
     */
    ...
    /**
     * Retrieve the branch_code from the current session.
     *
     * @return String The branch's code or NULL.
     */
    ...
    /**
     * Retrieve the display_name from the current session.
     *
     * @return String The display_name's ID or NULL.
     */
     ...
     */
    private function setupSession($userId, $username, $hash, $email, $roleId, $remember = false, $oldToken = null, $company_id, $branch_code)
    {
