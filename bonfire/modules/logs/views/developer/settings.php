	...
	<?php echo form_open(site_url(SITE_AREA . '/developer/logs/enable'), 'class="form-horizontal"'); ?>
        <fieldset>
            <div class="form-group">
                <label for="log_threshold" class="col-4 col-form-label"><?php echo lang('logs_the_following'); ?></label>
                <div class="col-8">
                    <select class="custom-select" name="log_threshold" id="log_threshold">
