        ...
        ?>
            <fieldset id="module_details">
                ...
                <div class="form-group<?php echo form_error('module_name') ? ' error' : ''; ?>">
                    ...
                    <div class="controls">
                        <input class="form-control" name="module_name" id="module_name" type="text" value="<?php echo set_value("module_name"); ?>" placeholder="<?php echo lang('mb_form_mod_name_ph'); ?>" />
                ...
                <div class="form-group mb_advanced<?php echo form_error('module_description') ? ' error' : ''; ?>">
                    ...
                    <div class="controls">
                        <input  class="form-control"  name="module_description" id="module_description" type="text" value="<?php echo set_value("module_description", lang('mb_form_mod_desc_ph')); ?>" placeholder="<?php echo lang('mb_form_mod_desc_ph'); ?>" />
            ...
            <fieldset id="db_details">
                ...
                //--------------------------------------------------------------
                ?>
                <div class="form-group mb_advanced<?php echo form_error('table_name') ? ' text-danger' : ''; ?>">
                ...
                <div class="form-group mb_advanced<?php echo form_error('form_error_delimiters') ? ' text-danger' : ''; ?>">
                    <label for="form_error_delimiters" class="control-label block"><?php echo lang('mb_form_err_delims'); ?></label>
                    <div class="controls">
                        <input name="form_error_delimiters" id="form_error_delimiters" type="text" value="<?php echo set_value("form_error_delimiters", "<span class='text-danger'>,</span>"); ?>" />
                ...
                <div class="form-group mb_advanced<?php echo form_error('soft_delete_field') ? ' text-danger' : ''; ?>">
                ...
                <div class="form-group mb_advanced<?php echo form_error('deleted_by_field') ? ' text-danger' : ''; ?>">
                ...
                <div class="form-group mb_advanced<?php echo form_error('created_field') ? ' text-danger' : ''; ?>">
                ...
                <div class="form-group mb_advanced<?php echo form_error('created_by_field') ? ' text-danger' : ''; ?>">
                ...
                <div class="form-group mb_advanced<?php echo form_error('modified_field') ? ' text-danger' : ''; ?>">
                ...
                <div class="form-group mb_advanced<?php echo form_error('modified_by_field') ? ' text-danger' : ''; ?>">
                ...
                <div class="form-group mb_new_table<?php echo form_error('primary_key_field') ? ' text-danger' : ''; ?>">
                    <label for="primary_key_field" class="control-label block"><?php echo lang('mb_form_primarykey'); ?></label>
                    <div class="controls">
                        <input class="form-control" name="primary_key_field" id="primary_key_field" type="text" value="<?php echo set_value("primary_key_field", (isset($existing_table_fields[0]) && $existing_table_fields[0]['primary_key']) ? $existing_table_fields[0]['name'] : 'id'); ?>" />
            ...
            <div id="all_fields">
                ...
                <fieldset id="field<?php echo $count; ?>_details">
                    ...
                    <?php endif; ?>
                    <div class="form-group<?php echo form_error($viewFieldLabel) ? ' text-danger' : ''; ?>">
                        <label class="control-label" for="<?php echo $viewFieldLabel; ?>"><?php echo lang('mb_form_label'); ?></label>
                        <div class="controls">
                            <input class="form-control" name="<?php echo $viewFieldLabel; ?>" id="<?php echo $viewFieldLabel; ?>" type="text" value="<?php echo set_value($viewFieldLabel, isset($existing_table_fields[$count]) ? ucwords(str_replace('_', ' ', $existing_table_fields[$count]['name'])) : ''); ?>" placeholder="<?php echo lang('mb_form_label_ph'); ?>" />
                            <span class="help-inline"><?php echo form_error($viewFieldLabel); ?></span>
                        </div>
                    </div>
                    <div class="form-group<?php echo form_error($viewFieldName) ? ' text-danger' : ''; ?>">
                        <label class="control-label" for="<?php echo $viewFieldName; ?>"><?php echo lang('mb_form_fieldname'); ?></label>
                        <div class="controls">
                            <input class="form-control col-4" name="<?php echo $viewFieldName; ?>" id="<?php echo $viewFieldName; ?>" type="text" value="<?php echo set_value($viewFieldName, isset($existing_table_fields[$count]) ? $existing_table_fields[$count]['name'] : ''); ?>" maxlength="30" placeholder="<?php echo lang('mb_form_fieldname_ph'); ?>" />
                    ...
                    echo form_dropdown($viewFieldType, $view_field_types, set_value($viewFieldType, $default_field_type), lang('mb_form_type'), 'class="custom-select"', '<span class="help-inline">' . form_error($viewFieldType) . '</span>');
                    echo form_dropdown($dbFieldType, $db_field_types, set_value($dbFieldType, isset($existing_table_fields[$count]) ? $existing_table_fields[$count]['type'] : ''), lang('mb_form_dbtype'), 'class="custom-select"', '<span class="help-inline">' . form_error($dbFieldType) . '</span>');
                    ...
                    ?>
                    <div class="form-group <?php echo form_error($dbFieldLength) ? 'text-danger' : ''; ?>">
                        <label class="control-label" for="<?php echo $dbFieldLength; ?>"><?php echo lang('mb_form_length'); ?></label>
                        <div class="controls">
                            <input class="form-control" name="<?php echo $dbFieldLength; ?>" id="<?php echo $dbFieldLength; ?>" type="text" value="<?php echo set_value($dbFieldLength, $default_max_len); ?>" placeholder="<?php echo lang('mb_form_length_ph'); ?>" />
