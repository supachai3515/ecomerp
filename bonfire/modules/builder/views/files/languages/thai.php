...
\$lang['{$module_name_lower}_edit']        = 'แก้ไข';
\$lang['{$module_name_lower}_true']        = 'ใช่';
\$lang['{$module_name_lower}_false']       = 'ไม่ใช่';
\$lang['{$module_name_lower}_create']      = 'สร้าง';
\$lang['{$module_name_lower}_list']        = 'รายการ';
\$lang['{$module_name_lower}_new']       = 'ใหม่';
...
// Column Headings
\$lang['{$module_name_lower}_column_created']  = 'สร้าง';
\$lang['{$module_name_lower}_column_deleted']  = 'ลบ';
\$lang['{$module_name_lower}_column_modified'] = 'แก้ไข';
\$lang['{$module_name_lower}_column_deleted_by'] = 'ลบโดย';
\$lang['{$module_name_lower}_column_created_by'] = 'สร้างโดย';
\$lang['{$module_name_lower}_column_modified_by'] = 'แก้ไขโดย';
