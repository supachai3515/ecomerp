<fieldset>
    ...
    <div class="fotn-control form-group<?php echo form_error('allow_register') ? $errorClass : ''; ?>">
        <div class="controls">
    ...
    <div class="form-group<?php echo form_error('user_activation_method') ? $errorClass : ''; ?>">
        ...
        <div class="controls">
            <select name="user_activation_method" class="custom-select" id="user_activation_method">
    ...
    <div class="form-group<?php echo form_error('login_type') ? $errorClass : ''; ?>">
        ...
        <div class="controls">
            <select name="login_type" class="custom-select" id="login_type">
    ...
    <div class="form-group">
        ...
        <div class="controls" aria-labelledby='allow_name_change_label' role='group'>
            ...
            <div id="name-change-settings"<?php echo $settings['auth.allow_name_change'] ? '' : ' style="display:none"'; ?>>
                <input class="form-control" type="text" name="name_change_frequency" value="<?php echo set_value('auth.name_change_frequency', isset($settings['auth.name_change_frequency']) ? $settings['auth.name_change_frequency'] : ''); ?>" />
                <?php echo lang('set_name_change_frequency'); ?>
                <input class="form-control" type="text" name="name_change_limit" value="<?php echo set_value('auth.name_change_limit', isset($settings['auth.name_change_limit']) ? $settings['auth.name_change_limit'] : ''); ?>" />
    ...
    <div class="control-group<?php echo form_error('remember_length') ? $errorClass : ''; ?>" id="remember-length"<?php echo $settings['auth.allow_remember'] ? '' : ' style="display:none"'; ?>>
        ...
        <div class="controls">
            <select name="remember_length" class="custom-select" id="remember_length">
    ...
    <div class="control-group<?php echo form_error('password_min_length') ? $errorClass : ''; ?>" id="password-strength">
        ...
        <div class="controls">
            <input class="form-control" type="text" name="password_min_length" id="password_min_length" value="<?php echo set_value('password_min_length', isset($settings['auth.password_min_length']) ? $settings['auth.password_min_length'] : ''); ?>" class="fotn-control" />
    ...
    <div class="control-group<?php echo form_error('password_iterations') ? $errorClass : ''; ?>">
        ...
        <div class="controls">
            <select name="password_iterations" class="custom-select" id='password_iterations'>
