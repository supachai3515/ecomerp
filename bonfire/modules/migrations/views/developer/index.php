...
<div class="admin-box">
	<ul class="nav nav-tabs">
		<li class="nav-item"><a class="nav-link active" href="#app-tab" data-toggle="tab"><?php echo lang('migrations_tab_app'); ?></a></li>
		<li class="nav-item"><a class="nav-link" href="#mod-tab" data-toggle="tab"><?php echo lang('migrations_tab_mod'); ?></a></li>
		<li class="nav-item"><a class="nav-link" href="#core-tab" data-toggle="tab"><?php echo lang('migrations_tab_core'); ?></a></li>
	</ul>
                        ...
                        <tr>
                            ...
                            <td class='migrate'>
                                <?php echo form_open(site_url(SITE_AREA . "/developer/migrations/migrate_module/{$module}"), 'class="form-horizontal"'); ?>
                                    ...
                                    <select class="custom-select col-6 custom-select-sm" name="version">
                                    ...
                                    <input type="submit" name="migrate" class="btn btn-primary btn-sm" value="<?php echo lang('migrations_migrate_module'); ?>" />
                                <?php echo form_close(); ?>
                            </td>
                        </tr>
                        <?php endforeach; ?>
            ...
            <?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
                <fieldset>
					...
					<div class="form-group">
						...
						<div class="controls">
							<select class="custom-select col-4" name="migration" id="migration">
                                <option value=""></option>
