...
// API Version 1.0
Route::any('v1/salesman', 'salesman/api');
Route::any('v1/salesman/(:any)', 'salesman/api/$1');
Route::any('v1/customer', 'customer/api');
Route::any('v1/customer/(:any)', 'customer/api/$1');
Route::any('v1/routing', 'routing/api');
Route::any('v1/routing/(:any)', 'routing/api/$1');
Route::any('v1/salesorder', 'salesorder/api');
Route::any('v1/salesorder/(:any)', 'salesorder/api/$1');
...
// All company settings move to company module
// Route::any('my/settings', 'company/settings/index'); 
// Route::any('my/settings/(:any)', 'company/settings/$1'); 
