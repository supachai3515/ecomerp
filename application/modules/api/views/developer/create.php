                    ...
                    <div class='col-md-12'>
                        ...
                        <fieldset>
                            ...
                            <div class="form-group row">
                                ...
                                <div class='col-8'>
                                    <input class="form-control<?php echo form_error('user_id') ? ' is-invalid' : ''; ?>" id='user_id' type='text' name='user_id' maxlength='11' value="<?php echo set_value('user_id', isset($api->user_id) ? $api->user_id : $auth['user_id']); ?>" />
                            ...
                            <div class="form-group row">
                                ...
                                <div class='col-8'>
                                    <input class="form-control<?php echo form_error('key') ? ' is-invalid' : ''; ?>" id='key' type='text' name='key' maxlength='40' value="<?php echo set_value('key', isset($api->key) ? $api->key : $generate_key); ?>" />
                            ...
                            <div class="form-group row">
                                ...
                                <div class='col-8'>
                                    <input class="form-control<?php echo form_error('level') ? ' is-invalid' : ''; ?>" id='level' type='text' name='level' maxlength='2' value="<?php echo set_value('level', isset($api->level) ? $api->level : '10'); ?>" />
                            ...
                            <div class="form-group row">
                                ...
                                <div class='col-8'>
                                    <?php echo form_textarea(array('name' => 'ip_addresses', 'id' => 'ip_addresses', 'rows' => '2', 'value' => set_value('ip_addresses', isset($api->ip_addresses) ? $api->ip_addresses : $ipaddress))); ?>
                                    <span class='help-inline'><?php echo form_error('ip_addresses'); ?></span>
                                </div>
                            </div>
                        </fieldset>
                        <fieldset class='form-actions mt-2'>
                            <input type='submit' name='save' class='btn btn-primary' value="<?php echo lang('api_action_create'); ?>" />
                            <?php echo lang('bf_or'); ?>
