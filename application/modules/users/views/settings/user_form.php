        ...
        <div class="col-8">
            ...
            <fieldset>
                ...
                <div class="control-group mb-3">
                    ...
                    <div class="controls">
                        <select name="role_id" id="role_id" class="chzn-select custom-select <?php echo $controlClass; ?>">
                            <?php
                ...
                <div class="control-group mb-3"> 
                    ...
                    <label for="company_id" class="control-label"><?php echo lang('us_company'); ?></label>
                    <div class="controls">
                        <select name="company_id" id="company_id" class="chzn-select custom-select <?php echo $controlClass; ?>">
                            <?php
                            if (! empty($companies) && is_array($companies)) :
                                foreach ($companies as $company) :
                                    if ($userIsAdmin) :
                                        // The selected role is the role assigned to the
                                        // user or the site's default role.
                                        $selectedCompany = isset($user) ? ($user->company_id == $company->id)
                                            : 1;
                            ?>
                            <option value="<?php echo $company->id; ?>" <?php echo set_select('company_id', $company->id, $selectedCompany); ?>>
                                <?php e(ucfirst($company->name)); ?>
                            </option>
                            <?php
                                    endif;
                                endforeach;
            ...
            <?php endif; ?>
            <fieldset class="form-actions mt-4">
