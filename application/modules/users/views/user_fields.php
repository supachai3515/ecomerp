...
<?php if ($editSettings) : ?>
<div class="control-troup form-group<?php echo form_error('force_password_reset') ? $errorClass : ''; ?>">
    <div class="controls">
...
<div class="control-group form-group<?php echo form_error('language') ? $errorClass : ''; ?>">
    ...
    <div class="controls">
        <select name="language" id="language" class="chzn-select <?php echo $controlClass; ?> custom-select">
