...
$config['auth_override_class_method_http']['product']['index']['get'] = 'none';
$config['auth_override_class_method_http']['product']['fabric_color']['get'] = 'none';
$config['auth_override_class_method_http']['product']['button_color']['get'] = 'none';
$config['auth_override_class_method_http']['car']['getpopularcar']['post'] = 'none';
$config['auth_override_class_method_http']['car']['getallcar']['post'] = 'none';
$config['auth_override_class_method_http']['car']['getrelated']['post'] = 'none';
$config['auth_override_class_method_http']['car']['getfuture']['post'] = 'none';
$config['auth_override_class_method_http']['car']['getimage']['post'] = 'none';
$config['auth_override_class_method_http']['car']['getfiltercar']['post'] = 'none';
$config['auth_override_class_method_http']['car']['carbyid']['post'] = 'none';
/*
|--------------------------------------------------------------------------
...
|
*/
$config['rest_key_name'] = 'mhtl-api-key';
