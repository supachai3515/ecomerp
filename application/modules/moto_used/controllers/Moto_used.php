 ...
 * Content controller
 */
class moto_used extends Admin_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->lang->load('moto_used');
        $this->load->model("moto_used_model");
    ...
    public function index()
    {
        try {
            //set title
            Template::set('toolbar_title',lang('moto_used_title'));
            Assets::add_module_js('moto_used', 'moto_used.js');
    ...
    public function search()
    {
        try {
            ...
            //Total number
            $sql = "SELECT count(*) total   FROM sellingmoto u WHERE 1=1 $sqlwhere";
            $result = $this->db->query($sql);
            $totalRecords = $result->row()->total;
            $sql = "SELECT u.* FROM  sellingmoto u  WHERE 1=1 $sqlwhere ORDER BY  $columnName  $columnSortOrder  limit  $row , $rowperpage ";
            $result = $this->db->query($sql);
    ...
    public function view()
    {
        try {
            ...
            $data['action']  = "view";
            $data['moto_used_data']  = $this->moto_used_model->get_sellingmoto_byid($id);
            $this->load->view("moto_used_partial", $data);
        } catch (\Throwable $th) {
            $this->output
