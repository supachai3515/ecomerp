...
$(document).ready(function() {
    ...
    function col_action(data) {
        var str = "";
        str = str + ' <button  type="button" data-url="'+base_url+'/car_used/edit/?id=' + data.id + '"  class="btn btn-sm btn-outline-warning action_click"><i class="far fa-edit"></i></button>';
        str = str + ' <button  type="button" data-url="'+base_url+'/car_used/view/?id=' + data.id + '"  class="btn btn-sm btn-outline-info action_click"><i class="fas fa-search"></i></button>';
        return str;
    }
